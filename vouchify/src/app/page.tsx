          ...
          <ol className="col-span-4 md:col-span-8 md:col-start-5">
            {setupSteps.map((step) => (
              ...
              >
                <span
                  data-numeric
                  className="font-display text-2xl font-extrabold leading-none tracking-tight text-gold-deep md:text-3xl"
                >
                  {step.n}
                </span>
                ...
                return (
                  <li key={placement.n} className="flex gap-4 py-4">
                    <span
                      ...
                      className={
                        placed
                          ? 'grid h-6 w-6 shrink-0 place-items-center rounded-full bg-gold text-2xs font-semibold text-ink'
