...
const swatches = [
  ...
  { name: 'signal', hex: '#FF4D14', use: 'The one accent. CTA fills, active tier, savings emphasis.', on: 'ink text', ratio: '5.92:1' },
  { name: 'signal-hover', hex: '#E63F08', use: 'Hover/pressed fill for the primary button only.', on: 'ink text', ratio: '4.76:1' },
  { name: 'signal-deep', hex: '#C43305', use: 'The accent darkened for small orange TEXT on light.', on: 'paper', ratio: '5.00:1' },
  { name: 'signal-tint', hex: '#FFE9E1', use: 'Flat wash behind the selected tier row.', on: 'ink text', ratio: '16.86:1' },
];
...
const sampleFaq = [
  ...
  },
  {
    ...
    answer: (
      <p>
        Yes, free and unlimited. The chip stores a TapRate address that forwards to your review page,
        ...
        <Grid className="gap-y-10">
          ...
          <div className="col-span-4 md:col-span-9">
            ...
            <p className="mt-4 max-w-prose text-xs text-warm-600">
              ...
              <span className="font-semibold text-signal-deep">signal-deep</span> carries orange text
        ...
        <Grid className="gap-y-10">
          ...
          <div className="col-span-4 md:col-span-9">
            ...
            <div className="mt-6 flex flex-wrap items-end gap-6">
              ...
              <Price cents={2800} size="sm" tone="signal" display={false} />
