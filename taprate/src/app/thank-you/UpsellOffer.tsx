...
export function UpsellOffer({
  ...
  if (status === 'added') {
    return (
      <div className="rounded-md border border-signal bg-signal-tint p-6">
  ...
  return (
    <div className="rounded-md border-2 border-signal bg-paper p-6">
      ...
      <dl className="mt-6 grid grid-cols-2 gap-x-6 border-y border-warm-300 sm:grid-cols-4">
        ...
        <div className="py-3">
          ...
          <dd data-numeric className="mt-1 font-display text-lg font-bold tracking-tight text-signal-deep">
