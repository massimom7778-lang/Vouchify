...
function Field({
  ...
  return (
    <label className="block">
      ...
      {error ? (
        <span role="alert" className="mt-1.5 block text-xs font-semibold text-signal-deep">
          {error}
        </span>
      ) : null}
    </label>
  ...
  return (
    <form onSubmit={onSubmit} noValidate className="rounded-md border border-warm-300 bg-warm-50 p-5 md:p-6">
      ...
      <label className="mt-5 flex cursor-pointer items-start gap-3">
        <input name="logoPrinting" type="checkbox" className="mt-1 h-4 w-4 shrink-0 accent-[#FF4D14]" />
        <span>
