  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'The chip holds a short TapRate address that forwards to your review page. Each forward is counted so you can see which stand is doing the work.',
    ...
    sections: [
      {
        ...
        body: [
          ...
          'Link changes are free and unlimited. If TapRate ever stops operating the forwarder, we will publish a way to reprogram your chips to point directly at your review page.',
        ],
      },
      {
        heading: 'Review policy',
        body: [
          'TapRate is built to ask every customer for feedback, not to filter for happy ones. We do not build review gating, we do not support routing negative feedback to a private form, and we will not add either.',
      ...
      },
      {
        heading: 'Trademarks',
        body: [
          'Google and Google Business Profile are trademarks of Google LLC. TapRate is not affiliated with, endorsed by, or sponsored by Google LLC.',
