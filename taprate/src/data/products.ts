...
export const coreProduct = {
  ...
  photos: {
    hero: {
      ...
      alt: 'TapRate NFC review stand in black, standing on a counter',
      aspect: 'square',
    },
    inHand: {
      id: 'core-in-hand',
...
export const addOns: readonly AddOn[] = [
  ...
  },
  {
    ...
    specs: [
      { label: 'Size', value: '50 mm round' },
      { label: 'Adhesive', value: 'Indoor acrylic, removable within 30 days' },
      { label: 'Chip', value: 'NTAG213, encoded before shipping' },
    ],
    photo: {
      id: 'addon-sticker',
  ...
  },
  {
    ...
    photo: {
      ...
      alt: 'A packed TapRate shipping mailer',
      aspect: 'square',
    },
  },
];
