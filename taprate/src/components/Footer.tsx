        ...
        <div className="grid grid-cols-4 gap-x-6 gap-y-10 md:grid-cols-12">
          <div className="col-span-4 md:col-span-4">
            ...
            <a
              ...
              className="mt-5 inline-block text-sm font-semibold underline decoration-warm-500 underline-offset-4 hover:decoration-signal"
            >
              {site.supportEmail}
            </a>
          </div>
            ...
            <nav key={group.heading} aria-label={group.heading} className="col-span-2 md:col-span-2 md:col-start-auto">
              ...
              <ul className="mt-4 space-y-2.5">
                {group.links.map((link) => (
                  <li key={link.href}>
                    <Link href={link.href} className="text-sm text-warm-300 hover:text-signal">
                      {link.label}
                    </Link>
                  </li>
                ))}
          ...
          <div className="col-span-4 md:col-span-3 md:col-start-10">
            ...
            <Link
              href="/multi-location"
              className="mt-4 inline-block text-sm font-semibold text-signal underline decoration-warm-700 underline-offset-4 hover:decoration-signal"
            >
              Get a quote
            </Link>
          </div>
