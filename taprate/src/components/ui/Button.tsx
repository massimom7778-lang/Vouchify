...
const variants: Record<ButtonVariant, string> = {
  // The single most important button on the site. Ink on signal is 5.9:1.
  primary:
    'bg-signal text-ink border-signal hover:bg-signal-hover hover:border-signal-hover on-signal',
  ...
  quiet:
    'bg-transparent text-ink border-transparent underline decoration-warm-400 underline-offset-4 hover:decoration-signal-deep',
};
