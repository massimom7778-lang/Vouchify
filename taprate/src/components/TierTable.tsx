    ...
    <>
      ...
      <table className="hidden w-full border-collapse text-left md:table">
        <caption className="sr-only">
          TapRate stand bundles, prices and per-unit savings
        </caption>
        <thead>
        ...
        <tbody>
          {standTiers.map((tier) => {
            ...
            return (
              <tr
                key={tier.id}
                className={cn('border-b border-warm-300', highlight && 'bg-signal-tint')}
              >
                ...
                <td className="py-5 pr-4 align-top text-sm">
                  {economics.savingsCents > 0 ? (
                    <span data-numeric className="font-semibold text-signal-deep">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                highlight ? 'border-signal bg-signal-tint' : 'border-warm-300 bg-paper',
              )}
            >
              ...
              {economics.savingsCents > 0 ? (
                <span data-numeric className="mt-1 block text-xs font-semibold text-signal-deep">
